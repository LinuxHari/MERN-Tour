           ...
           <div className="headerDropdown">
             <div className="headerDropdown__container">
                 ...
                 <div className="headerDropdown__item text-decoration-none">
                   <button className="text-danger d-flex align-items-center text-decoration-none" onClick={openModal}><i className="icon-logout text-18 text-decoration-none"/> &nbsp; Logout</button>
                 </div>
