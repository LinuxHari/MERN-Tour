      ...
      <div className="contactForm row y-gap-30">
        {fields.map((_, index) => (
          <React.Fragment key={index}>
            ...
            <div className="col-lg-6">
              <Input type="text" label="Map Latitude" {...register(`itinerary.${index}.lat`, {valueAsNumber: true})} />
            </div>
            <div className="col-lg-6">
              <Input type="text" label="Map Longitude" {...register(`itinerary.${index}.lon`, {valueAsNumber: true})} />
            </div>
          </React.Fragment>
        ))}
        {fields.length < 10 && (
