                ...
                <div className="size-200 rounded-12 border-dash-1 bg-accent-1-05 flex-center flex-column">
                  ...
                  >
                    ...
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M30.3674 0.499385C30.8556 0.011232 31.6469 0.011232 32.1351 0.499385L37.4684 5.83273C37.9566 6.32088 37.9566 7.11233 37.4684 7.60049C36.9803 8.08864 36.1889 8.08864 35.7008 7.60049L31.2513 3.15103L26.8018 7.60049C26.3137 8.08864 25.5222 8.08864 25.0341 7.60049C24.5459 7.11233 24.5459 6.32088 25.0341 5.83273L30.3674 0.499385Z"
                      fill="#EB662B"
                    />
                  </svg>

                  <div className="text-14 mt-20">
                    Drop your photo here or <span className="text-purple-1">Browse</span>
                  </div>
                  <div className="text-10 mt-10">Maximum size: 10 MB</div>
                </div>
              </div>
            </div>
          </div>
