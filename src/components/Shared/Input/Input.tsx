  ...
  if (type === "checkbox") {
    return (
      <div className="form-checkbox d-flex items-center">
        ...
        <label htmlFor={inputProps.name} className="lh-16 ml-10">
          {label}
        </label>
      </div>
    );
    ...
    return (
      <div className={`form-radio ${wrapperClassName}`}>
        <div className="radio d-flex items-center">
          ...
          <label htmlFor={inputProps.name} className="text-14 lh-1 ml-10">
            {label}
          </label>
        </div>
      </div>
    ...
    return (
      <div>
        <label htmlFor={inputProps.name} className="cursor-pointer">
          <ImagePlaceholder size={1} byteSize="MB" />
        </label>
