...
const StarRatingSchema = z.object({
    ...
    title: z.string().min(2, {message: "Title should have atleast two characters"}).max(100, {message: "Title should not exceed more than 100 characters"}).optional(),
    comment: z.string().min(2, {message: "Comment should have atleast two characters"}).max(500, {message: "Comment should not exceed more than 500 characters"}).optional()
  });

export type StarRatingType = z.infer<typeof StarRatingSchema>

export default StarRatingSchema